...
//        phases.add(new InstanceLifecyclePhase<>(Phases.TRANSFORM_TOSCA, this, InstancePluginLifecycle::transformEdmmiToTOSCA));
        ...
        phases.add(new InstanceLifecyclePhase<>(Phases.STORE_TRANSFORMED_TOSCA, this, InstancePluginLifecycle::storeTransformedTOSCA, context -> !context.isMultiTransform()));
