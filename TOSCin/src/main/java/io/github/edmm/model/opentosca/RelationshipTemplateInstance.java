...
public class RelationshipTemplateInstance {
    ...
    public static RelationshipTemplateInstance ofRelationInstance(
        ...
        relationshipTemplateInstance.setRelationshipType(new QName(OpenTOSCANamespaces.OPENTOSCA_BASE_TYPES,
            String.valueOf(relationInstance.getType().toToscaRelationBaseType())));
        ...
        relationshipTemplateInstance.setState(componentInstance.getState()
            .toTOSCANodeTemplateInstanceState()
            .convertToRelationshipTemplateInstanceState());
