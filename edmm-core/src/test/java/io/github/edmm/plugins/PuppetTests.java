...
import io.github.edmm.plugins.puppet.PuppetLifecycle;
...
public class PuppetTests {
    ...
    public void init() throws Exception {
        targetDirectory = Files.createTempDirectory("puppet-").toFile();
    ...
    public void test() {
        // Setup plugin
        PuppetPlugin plugin = new PuppetPlugin();
        PuppetLifecycle lifecycle = plugin.getLifecycle(context);
